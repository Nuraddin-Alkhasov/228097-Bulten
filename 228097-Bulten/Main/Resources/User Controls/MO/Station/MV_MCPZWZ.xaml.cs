...
namespace HMI.Resources.UserControls.MO
{
    public partial class MV_MCPZWZ : UserControl
    {
        ...
        {
            InitializeComponent();
            PZTemp = "CPU1.PLC.Blocks.04 Tray handling.02 PZ.01 Air.DB PZ Air HMI.Actual.Temperature";
            PZRpm = "CPU1.PLC.Blocks.04 Tray handling.02 PZ.01 Air.DB PZ Air HMI.Actual.Circulation fan.Motor.Actual.Speed 2";
            PZCaster = "CPU1.PLC.Blocks.04 Tray handling.02 PZ.01 Air.DB PZ Air HMI.Actual.Caster";
            PZPurge = "CPU1.PLC.Blocks.04 Tray handling.02 PZ.01 Air.DB PZ Air HMI.Actual.Exhaust fan.State.isPurging";
            WZTemp = "CPU1.PLC.Blocks.04 Tray handling.03 WZ.01 Air.DB WZ Air HMI.Actual.Temperature";
            WZRpm = "CPU1.PLC.Blocks.04 Tray handling.03 WZ.01 Air.DB WZ Air HMI.Actual.Circulation fan.Motor.Actual.Speed 2";
            WZCaster = "CPU1.PLC.Blocks.04 Tray handling.03 WZ.01 Air.DB WZ Air HMI.Actual.Caster";
            WZPurge = "CPU1.PLC.Blocks.04 Tray handling.03 WZ.01 Air.DB WZ Air HMI.Actual.Exhaust fan.State.isPurging";
            WZStatus = "CPU1.PLC.Blocks.04 Tray handling.00 Main.DB TH HMI.Actual.State";
        }
