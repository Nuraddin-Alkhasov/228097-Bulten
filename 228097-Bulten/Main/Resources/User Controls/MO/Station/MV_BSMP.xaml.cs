        ...
        private void maniPos_Change(object sender, VariableEventArgs e)
        {
            ...
            switch ((short)e.Value) 
            {
                case 0:
                    ...
                    B.Children.Add(GetBasket("R", new Thickness(0, 221, 116, 0), 0));
                    B.Children.Add(GetBasket("L", new Thickness(0, 262, 116, 0),0));
                ...
                case 2:
                    ...
                    B.Children.Add(GetBasket("L", new Thickness(0, 305, 145, 0),2));
                    B.Children.Add(GetBasket("R", new Thickness(0, 322, 197, 0),2));
                    break;
                case 3:
                    ManiPosition.SymbolResourceKey = "MV_MP4";
                    B.Children.Add(GetBasket("L", new Thickness(0, 411, 99, 0),3));
                    B.Children.Add(GetBasket("R", new Thickness(0, 427, 150, 0),3));
                    break; 
                case 4:
                    ManiPosition.SymbolResourceKey = "MV_MP5";
                    B.Children.Add(GetBasket("R", new Thickness(0, 318, 216, 0),4));
                    B.Children.Add(GetBasket("L", new Thickness(0, 310, 270, 0),4));
                ...
                case 6:
                    ...
                    B.Children.Add(GetBasket("L", new Thickness(0, 231, 331, 0),6));
                    B.Children.Add(GetBasket("R", new Thickness(0, 270, 331, 0),6));
                    break;
                case 7:
                ...
                case 8:
                    ...
                    B.Children.Add(GetBasket("L", new Thickness(-3, 172, 446 , 0), 7));
                    B.Children.Add(GetBasket("R", new Thickness(-3, 212, 446 , 0), 7)); break;
            }
        }
