...
namespace HMI.Resources.UserControls.MO
{
    public partial class MV_HZ : UserControl
    {
        ...
        {
            InitializeComponent();
            HZTemp = "CPU1.PLC.Blocks.04 Tray handling.05 HZ 1.01 Air.DB HZ 1 Air HMI.Actual.Temperature";
            HZRpm = "CPU1.PLC.Blocks.04 Tray handling.05 HZ 1.01 Air.DB HZ 1 Air HMI.Actual.Circulation fan.Motor.Actual.Speed 2";
            HZCaster = "CPU1.PLC.Blocks.04 Tray handling.05 HZ 1.01 Air.DB HZ 1 Air HMI.Actual.Caster";
        }
