...
namespace HMI.Services
{
    ...
    public class Service_TimeSync : ServiceBase, ITimeSync
    {
        ...
        protected override void OnLoadProjectCompleted()
        {
            ...
            ToggleBit = VS.GetVariable("CPU1.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.General.ToggleBit");
            ToggleBit.Change += ToggleBit_Change;
        ...
        void ToggleBit_Change(object sender, VariableEventArgs e)
        {
            if ((bool)e.Value)
            {
