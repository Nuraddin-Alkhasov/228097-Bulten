...
namespace HMI.DialogRegion.MO.Views
{
	...
	public partial class MO_Sheduler
    {
        ...
        {
            ApplicationService.SetVariableValue("CPU1.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.General.Timer.On", true);
        }

        private void RightButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ApplicationService.SetVariableValue("CPU1.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.General.Timer.On", false);
        }
