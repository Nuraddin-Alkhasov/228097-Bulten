...
namespace HMI.DialogRegion.MO.Views
{
    ...
    public partial class MO_WZ_EF
    {
        ...
        private void View_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            VStatus = VS.GetVariable("CPU1.PLC.Blocks.04 Tray handling.03 WZ.01 Air.DB WZ Air HMI.Actual.Exhaust fan.State.Ventilator");
            VStatus.Change += VStatus_Change;

            VPurge = VS.GetVariable("CPU1.PLC.Blocks.04 Tray handling.03 WZ.01 Air.DB WZ Air HMI.Actual.Exhaust fan.State.isPurging");
            VPurge.Change += VPurge_Change;

            VPS1 = VS.GetVariable("CPU1.PLC.Blocks.04 Tray handling.03 WZ.01 Air.DB WZ Air HMI.Actual.Exhaust fan.State.Pressure switch 1");
            VPS1.Change += VPS1_Change;

            VPS2 = VS.GetVariable("CPU1.PLC.Blocks.04 Tray handling.03 WZ.01 Air.DB WZ Air HMI.Actual.Exhaust fan.State.Pressure switch 2");
