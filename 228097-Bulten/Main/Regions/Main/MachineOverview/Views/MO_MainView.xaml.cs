        ...
        private void AddObjects_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            Dispatcher.InvokeAsync(delegate
            {
                CI = new MV_CI
                {
                    ...
                    Margin = new Thickness(0, 463, 672, 0),
            ...
            Dispatcher.InvokeAsync(delegate
            {
                MVCZ = new MV_CZ()
                {
                    Margin = new Thickness(0, 342, 1012, 0),
                    HorizontalAlignment = HorizontalAlignment.Right,
                    VerticalAlignment = VerticalAlignment.Top
                };
            ...
            Dispatcher.InvokeAsync(delegate
            {
                ...
                {
                    Margin = new Thickness(0, 240, 615, 0),
                    HorizontalAlignment = HorizontalAlignment.Right,
                    VerticalAlignment = VerticalAlignment.Top
                };
            ...
            Dispatcher.InvokeAsync(delegate
            {
                HZ1 = new MV_HZ()
                {
                    ...
                    Margin = new Thickness(0, 264, 1569, 0),
                    HorizontalAlignment = HorizontalAlignment.Right,
                    VerticalAlignment = VerticalAlignment.Top
                };
            ...
            Dispatcher.InvokeAsync(delegate
            {
                MVUS = new MV_US()
                {
                    Margin = new Thickness(0, 418, 742, 0),
                    HorizontalAlignment = HorizontalAlignment.Right,
                    VerticalAlignment = VerticalAlignment.Top
                };
            ...
            Dispatcher.InvokeAsync(delegate
            {
                BSMP = new MV_BSMP
                {
                    Margin = new Thickness(0, 140, 231, 0),
                    HorizontalAlignment = HorizontalAlignment.Right,
                    VerticalAlignment = VerticalAlignment.Top
                };
            ...
            Dispatcher.InvokeAsync(delegate
            {
                TM = new MV_TM()
                {
                    Margin = new Thickness(0, 461, 838, 0),
                    HorizontalAlignment = HorizontalAlignment.Right,
                    VerticalAlignment = VerticalAlignment.Top
                };
            ...
            Dispatcher.InvokeAsync(delegate
            {
                MVPO = new MV_PO()
                {
                    Margin = new Thickness(0, 418, 615, 0),
                    HorizontalAlignment = HorizontalAlignment.Right,
                    VerticalAlignment = VerticalAlignment.Top
                };
            ...
            Dispatcher.InvokeAsync(delegate
            {
                ST = new MV_ST
                {
                    Margin = new Thickness(0, 442, 455, 0),
                    HorizontalAlignment = HorizontalAlignment.Right,
                    VerticalAlignment = VerticalAlignment.Top
                };
            ...
            Dispatcher.InvokeAsync(delegate
            {
                CD = new MV_CD
                {
                    Margin = new Thickness(0, 257, 146, 0),
                    HorizontalAlignment = HorizontalAlignment.Right,
                    VerticalAlignment = VerticalAlignment.Top,
                };
            ...
            Dispatcher.InvokeAsync(delegate
            {
                Dispatcher.InvokeAsync(delegate
                {
                    LD = new MV_LD
                    {
                        Margin = new Thickness(0, 395, 63, 0),
                        HorizontalAlignment = HorizontalAlignment.Right,
                        VerticalAlignment = VerticalAlignment.Top,
                    };
